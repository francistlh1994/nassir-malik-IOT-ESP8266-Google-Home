...
void processWebScoketRequest(String data){
            ...
            if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      ...
                      message = "{\"state\":\"ON\"\"number\":\"FOUR\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay4, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"FOUR\"}";
                      currState = "OFF";
                    }
                  
            }else if(query == "?"){ //if command then execute   
              Serial.println("Recieved query!");
              int state = digitalRead(Relay4);
                 if(currState=="ON"){
                      message = "{\"state\":\"ON\"\"number\":\"FOUR\"}";
                    }else{
                      message = "{\"state\":\"OFF\"\"number\":\"FOUR\"}";
             ...
             if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      ...
                      message = "{\"state\":\"ON\"\"number\":\"FIVE\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay5, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"FIVE\"}";
                      currState = "OFF";
                    }
                  
            }else if(query == "?"){ //if command then execute   
              Serial.println("Recieved query!");
              int state = digitalRead(Relay5);
                 if(currState=="ON"){
                      message = "{\"state\":\"ON\"\"number\":\"FIVE\"}";
                    }else{
                      message = "{\"state\":\"OFF\"\"number\":\"FIVE\"}";
            ...
            if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      ...
                      message = "{\"state\":\"ON\"\"number\":\"SIX\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay6, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"SIX\"}";
                      currState = "OFF";
                    }
                  
            }else if(query == "?"){ //if command then execute   
              Serial.println("Recieved query!");
              int state = digitalRead(Relay6);
                 if(currState=="ON"){
                      message = "{\"state\":\"ON\"\"number\":\"SIX\"}";
                    }else{
                      message = "{\"state\":\"OFF\"\"number\":\"SIX\"}";
            ...
            if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      ...
                      message = "{\"state\":\"ON\"\"number\":\"SEVEN\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay7, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"SEVEN\"}";
                      currState = "OFF";
                    }
                  
            }else if(query == "?"){ //if command then execute   
              Serial.println("Recieved query!");
              int state = digitalRead(Relay7);
                 if(currState=="ON"){
                      message = "{\"state\":\"ON\"\"number\":\"SEVEN\"}";
                    }else{
                      message = "{\"state\":\"OFF\"\"number\":\"SEVEN\"}";
            ...
            if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      ...
                      message = "{\"state\":\"ON\"\"number\":\"EIGHT\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay8, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"EIGHT\"}";
                      currState = "OFF";
                    }
                  
            }else if(query == "?"){ //if command then execute   
              Serial.println("Recieved query!");
              int state = digitalRead(Relay8);
                 if(currState=="ON"){
                      message = "{\"state\":\"ON\"\"number\":\"EIGHT\"}";
                    }else{
                      message = "{\"state\":\"OFF\"\"number\":\"EIGHT\"}";
            ...
            if(query == "cmd"){ //if query check state
              Serial.println("Recieved command!");
                    if(state=="on"){
                      digitalWrite(Relay1, HIGH)(Relay2, HIGH)(Relay3, HIGH)(Relay4, HIGH)(Relay5, HIGH)(Relay6, HIGH)(Relay7, HIGH)(Relay8, HIGH);
                      message = "{\"state\":\"ON\"\"number\":\"ALL\"}";
                      currState = "ON";
                    }else{
                      
                      digitalWrite(Relay1, LOW)(Relay2, LOW)(Relay3, LOW)(Relay4, LOW)(Relay5, LOW)(Relay6, LOW)(Relay7, LOW)(Relay8, LOW);
                      message = "{\"state\":\"OFF\"\"number\":\"ALL\"}";
                      currState = "OFF";
                    }
